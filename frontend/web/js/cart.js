        ...
        /*if (parseInt(productData.productCount) == 0) {*/
           /* if (parseInt(productData.productPartnerCount) == 0 || productData.productPartnerCount == null) {*/
                ...
                if (productCount < parseInt(productData.productMin_zakaz) && +productData.productCount !== +productCount) {
                    orderInput.append('<span class="count_tooltip" style="top: -94px;">Запрашиваемое количество должно соответствовать минимальной партии, либо всему остатку на складе (при наличии).<span class="corner"></span></span>');
                    setTimeout(function () {
                    ...
                    orderInput.append('<span class="count_tooltip" style="top: -94px;">Запрашиваемое количество должно соответствовать указанной кратности, либо всему остатку на складе (при наличии).<span class="corner"></span></span>');
                    setTimeout(function () {
                        orderInput.find('.count_tooltip').fadeOut(function () {
                            $(this).remove();
                        });
                    ...
                    if(productCount * orderPrice > 0){
                        orderedPriceField.html((productCount * orderPrice).toFixed(2) + ' ₽');
                    }else {
