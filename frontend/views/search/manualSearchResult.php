                    ...
                    <tr>
                        <td class="product_name_td">
                            <div class="card_part name">
                                ...
                                <div class="firm_name">
                                    <a target="_blank"
                                       href="/manufacturer/<?= $oneProduct['_source']['properties']['proizvoditel']; ?>/"><?= $oneProduct['_source']['properties']['proizvoditel']; ?></a>
                                </div>
                                                ...
                                                <path d="M22.9,27.3c-2.1,0-3.8,1.7-3.8,3.8s1.7,3.8,3.8,3.8s3.8-1.7,3.8-3.8S25,27.3,22.9,27.3z M22.9,33.3c-1.2,0-2.2-1-2.2-2.2
                                                    ...
                                                    <div class="ordered_block hidden">
                                                        ...
                                                        <div class="ordered_count">В запросе: <span
                                                                    class="bold"> </span></div>
                                                        <br>
                                                        <div class="ordered_price">Сумма: <span
                                                                    class="bold">по запросу</span></div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="stores_order left_bordered">
                                            ...
                                            <g>
                                                ...
                                                <div class="ordered_block hidden">
                                                    <div class="ordered_icon_close js-cancel-order flr"></div>
                                                    <div class="ordered_count">В запросе: <span class="bold"> </span>
                                                    </div>
                                                    <br>
                                                    <div class="ordered_price">Сумма: <span
                                                                class="bold">по запросу</span></div>
                                            ...
                                            <li class="docs_item pdf">
                                                <a class="docs_file_link " target="_blank" href="<?= $oneDoc; ?>">
                                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                         xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                         viewBox="0 0 174.7 212.3"
                                                         style="enable-background:new 0 0 174.7 212.3;"
                                                         xml:space="preserve">
<g>
    <path class="st0" fill="#336699"
          d="M101.2,171.1l-2.2,5.6h5.5l-2.1-5.6c-0.2-0.4-0.4-1-0.6-1.8C101.7,169.9,101.5,170.5,101.2,171.1z"/>
    ...
    <path class="st0" fill="#336699"
          d="M73.7,171.1l-2.2,5.6h5.5l-2.1-5.6c-0.2-0.4-0.4-1-0.6-1.8C74.1,169.9,73.9,170.5,73.7,171.1z"/>
    <path class="st0" fill="#336699" d="M98.1,64.4H72.4v5h25.7c1.4,0,2.5-1.1,2.5-2.5C100.6,65.5,99.5,64.4,98.1,64.4z"/>
    <path class="st0" fill="#336699"
          d="M98.1,84.8H63.9c-1.4,0-2.5,1.1-2.5,2.5s1.1,2.5,2.5,2.5h34.2c1.4,0,2.5-1.1,2.5-2.5S99.5,84.8,98.1,84.8z"/>
    ...
    <path class="st0" fill="#336699"
          d="M98.1,105.3H63.9c-1.4,0-2.5,1.1-2.5,2.5s1.1,2.5,2.5,2.5h34.2c1.4,0,2.5-1.1,2.5-2.5S99.5,105.3,98.1,105.3z"
    />
    ...
    <path class="st0" fill="#336699" d="M98.1,95H63.9c-1.4,0-2.5,1.1-2.5,2.5c0,1.4,1.1,2.5,2.5,2.5h34.2c1.4,0,2.5-1.1,2.5-2.5
		C100.6,96.1,99.5,95,98.1,95z"/>
                                                        ...
                                                        <g>
                                                            <path class="st1" fill="#961C28"
                                                                  d="M39.2,67.2h-2.9v4.6h2.8c0.8,0,1.5-0.2,1.9-0.6s0.7-1,0.7-1.7c0-0.7-0.2-1.3-0.7-1.7S40,67.2,39.2,67.2z"/>
        ...
        <?php } ?>
    <?php } else { ?>
        <div class="empty_man_search">по критерию поиска не найдено ни одного совпадения</div>
    <?php } ?>
...
<div class="prod_warn">
    ...
    Для покупателей с рамочными(календарными) поставками предоставляются специальные цены на полный объем, а также по
    договоренности гарантированный 1-2х месячный запас на буферном складе.

    Для торговых агентов и компаний-партнеров предоставляются персональные взаимовыгодные условия.

    Цены на сайте указаны за единицу товара в рублях РФ (с НДС) по курсу ЦБ РФ и действительны только в течении текущего
    дня. Цены не включают стоимость межтерминальной транспортировки.

    Доступное количество товара, указанное на сайте, действительно по состоянию на 9:00 (по Москве).

    Сроки отгрузки, указанные в наименовании товара, носят ознакомительный характер и действительны только на текущую
    дату.

    Внимание! Характеристики товаров на сайте указаны только для ознакомления, для получения точной информации
    используйте официальную техническую документацию от производителя.
</div>
<?php } ?>
