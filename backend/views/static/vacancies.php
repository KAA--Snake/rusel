...
$this->title = 'admin vacancies page';
...
<div class="inner_wrap mw1180">
    ...
    <h1 class="header_h1">Форма для редактирования страницы "Вакансии"</h1>

    <form action="/admin/static/add/" method="post" id="static_add-form" class="static_add-form" enctype="multipart/form-data">

        <input type="hidden" name="Artikle[type]" value="vacancies" />
        <input type="hidden" name="Artikle[id]" value="<?=$model->id;?>" />

        <input type="text" name="Artikle[name]" value="Вакансии" />
