                                        ...
                                        <ul class="docs_list">
                                            <?foreach($docs as $oneDoc){
                                                ...
                                                <li class="docs_item pdf">
                                                    <a class="docs_file_link " target="_blank" href="<?=Url::to('@catDocs/'.$oneDoc);?>"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
